...
# Those callbacks are private and called only from C, so without a keep rule R8 reads them
# as dead code and deletes them. The class is small; keeping it whole costs nothing, removes a
# whole class of runtime surprise, and covers any callback added later.
